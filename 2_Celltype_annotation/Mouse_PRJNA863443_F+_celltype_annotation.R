...
load("/Volumes/OIProject_II/1_R/2_Integration/Mouse/Benayoun_lab_Foxl2_model/2025-06-23_10x_ovary_Benayoun_lab_Foxl2_integrated_harmony.RData")
...
#scGate it!
my.ovary.Foxl2.Ptprc.pos <- scGate(data = ovary.Foxl2.harmony, model = my.scGate.model.Ptprc, assay = "RNA", verbose = TRUE)

t.pure <- as.matrix(table(my.ovary.Foxl2.Ptprc.pos$is.pure, my.ovary.Foxl2.Ptprc.pos$seurat_clusters))
...
#  [1] 11 18 19 21 22 28 30 31 32  4

# Assign cell type to each seurat cluster: Ptprc (CD45) positive cells clusters: 11, 18, 19, 21, 22, 28, 30, 31, 32, 4

my.ovary.Foxl2.Ptprc.pos <- SetIdent(my.ovary.Foxl2.Ptprc.pos, value = "seurat_clusters")
ovary.Foxl2 <- my.ovary.Foxl2.Ptprc.pos
...
ovary.Foxl2.Ptprc.pos <- SetIdent(ovary.Foxl2.Ptprc.pos, value = "SingleR.Immgen")
levels(ovary.Foxl2.Ptprc.pos) <- c("Neutrophils", "Macrophages" , "Monocytes", "DC" , "NK cells" ,  "ILC",  "NKT", "T cells",  "Tgd", "B cells", "Endothelial cells", "Fibroblasts", "Mast cells", "Epithelial cells")
DotPlot(ovary.Foxl2.Ptprc.pos, features = c("Csf3r", "Itgam", "Adgre1", "Itgax", "Klrb1c", "Ccl5", "Itga1", "Gata3", "Il17rb", "Ly6c2", "Cd3e", "Cd8b1", "Cd4", "Cd28", "Tmem176b", "Il7r", "Il2ra", "Cd19"))
...
cL_resutls = do.call("rbind", lapply(unique(ovary.Foxl2.Ptprc.pos@meta.data$SCT_snn_res.2), function(cl){
  es.max.cl = sort(rowSums(es.max[ ,rownames(ovary.Foxl2.Ptprc.pos@meta.data[ovary.Foxl2.Ptprc.pos@meta.data$SCT_snn_res.2==cl, ])]), decreasing = !0)
  head(data.frame(cluster = cl, type = names(es.max.cl), scores = es.max.cl, ncells = sum(ovary.Foxl2.Ptprc.pos@meta.data$SCT_snn_res.2==cl)), 10)
}))
...
VlnPlot(subset(ovary.Foxl2.Ptprc.pos, subset = seurat_clusters %in% c(22:29)), 
        features = c("S100a8",                                        # S100a8 - Neutrophil marker
                     "Ly6c2", "C1qa",                                 # Monocyte (Cd68, Ly6c2) & Macrophage (Cd63, C1qa) markers
                     "Flt3",                                          # DC marker
                     "Il2ra", "Ccdc184", "Klrb1c", "Fam184b", # ILC
...
# Refer to ./2024-10-15_10x_ovary_Benayoun_lab_Foxl2_Ptprc_positive_cells_annotation_results_FINAL.txt
################################

ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2 <- rep("NA",dim(ovary.Foxl2.Ptprc.pos@meta.data)[1])
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 0] <- "DPT"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 1] <- "DNT"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 2] <- "B"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 3] <- "NK"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 4] <- "NK"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 5] <- "Myeloid"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 6] <- "DNT"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 7] <- "NKT"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 8] <- "Myeloid"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 9] <- "NK"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 10] <- "DNT"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 11] <- "CD8T"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 12] <- "DNT"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 13] <- "NK"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 14] <- "NK"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 15] <- "NK"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 16] <- "CD8T"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 17] <- "B"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 18] <- "Neutrophil"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 19] <- "DC"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 20] <- "DPT"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 21] <- "ILC"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 22] <- "B"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 23] <- "DNT"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 24] <- "Myeloid"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 25] <- "CD4T"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 26] <- "DPT"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 27] <- "DC"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 28] <- "NKT"
ovary.Foxl2.Ptprc.pos@meta.data$celltype.level2[ovary.Foxl2.Ptprc.pos@meta.data$seurat_clusters %in% 29] <- "DPT"
...
DefaultAssay(ovary.Foxl2.Ptprc.neg) <- "SCT"

ovary.Foxl2.Ptprc.neg <- SetIdent(ovary.Foxl2.Ptprc.neg, value = "SingleR.cycling")
levels(ovary.Foxl2.Ptprc.neg) <- c("Oocyte",
                                   "Granulosa",
                                   "Theca",
                                   "Stroma",
                                   "Mesenchyme",
                                   ...
                                   "LEC",
                                   "Epithelial")
DotPlot(ovary.Foxl2.Ptprc.neg, features = c("Ddx4",                             # Oocyte marker
...
DotPlot(ovary.Foxl2.Ptprc.neg, features = c("Amh", "Fshr","Foxl2", "Nr5a2", "Kitl", "Cyp19a1",     # Granulosa cell marker
...
pdf(paste(Sys.Date(),"10X_ovary_Benayoun_Foxl2_Ptprc_negative_cells_SingleR_UMAP_annotated_GSE232309.pdf", sep = "_"), height = 7, width = 8)
DimPlot(ovary.Foxl2.Ptprc.neg, reduction = "umap", group.by = "SingleR.GSE232309")
dev.off()
...
ovary.Foxl2.Ptprc.neg <- SetIdent(ovary.Foxl2.Ptprc.neg, value = "SingleR.GSE232309")
levels(ovary.Foxl2.Ptprc.neg) <- c("Oocyte",
                                   "Granulosa",
                                   "Theca",
                                   "Stroma",
...
pdf(paste0(Sys.Date(),"_10x_ovary_Foxl2_Ptprc_negative_cells_Vlnplot_marker_genes_clusters_33_to_39.pdf"), width = 15, height = 20)
VlnPlot(subset(ovary.Foxl2.Ptprc.neg, subset = seurat_clusters %in% c(33:39)), 
        features = c("Ddx4",                             # Oocyte marker
                     "Amh", "Foxl2", "Cyp19a1",          # Granulosa cell marker
                     "Cyp17a1", "Cyp11a1", "Lhcgr",      # Theca cell marker 
                     "Pdgfra", "Col1a1",                 # Stroma cell marker
...
FindMarkers(ovary.Foxl2.Ptprc.neg, ident.1 = 0, only.pos = TRUE)

################################
# Transfer final annotations
# Refer to ./2024-10-15_10x_ovary_Benayoun_lab_Foxl2_Ptprc_negative_cells_annotation_results_FINAL.txt
################################
...
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 1] <- "BEC"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 2] <- "LEC"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 3] <- "Stroma"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 4] <- "Stroma"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 5] <- "Epithelial"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 6] <- "Stroma"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 7] <- "Granulosa"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 8] <- "LEC"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 9] <- "Theca"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 10] <- "Granulosa"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 11] <- "Theca"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 12] <- "Stroma"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 13] <- "BEC"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 14] <- "Granulosa"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 15] <- "Stroma"
...
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 18] <- "Stroma"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 19] <- "Theca"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 20] <- "Stroma"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 21] <- "Stroma"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 22] <- "LEC"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 23] <- "Granulosa"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 24] <- "BEC"
...
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 28] <- "Theca"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 29] <- "Theca"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 30] <- "Granulosa"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 31] <- "Granulosa"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 32] <- "Epithelial"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 33] <- "Stroma"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 34] <- "Granulosa"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 35] <- "SMC"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 36] <- "Theca"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 37] <- "Epithelial"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 38] <- "BEC"
ovary.Foxl2.Ptprc.neg@meta.data$celltype.level2[ovary.Foxl2.Ptprc.neg@meta.data$seurat_clusters %in% 39] <- "Stroma"
...
################################################################################################################################################################
sink(file = paste(Sys.Date(),"_10x_ovary_Benayoun_lab_Foxl2_cell_type_annotation_session_Info.txt", sep =""))
sessionInfo()
sink()
